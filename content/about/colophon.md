...
The site is built with <a target="_blank" rel="noopener" href="//gohugo.io">Hugo</a>—a static site generator made with Go. The website [source code](https://github.com/emmgro/emmgro.github.io) is available on GitHub. It uses the <a target="_blank" rel="noopener" href="//github.com/nishanths/cocoa-hugo-theme">cocoa</a> theme. The posts are written in Markdown.
...
If you find errors, <a href="mailto:emmaguerreros@gmail.com">please let me know</a>.
